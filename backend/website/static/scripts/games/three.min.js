...
function matchScoreCheck()
{
	if (score1 >= maxScore)
	{
		...
		const durationFormated = new Date(Time).toISOString();
		afficherFinJeu();
		sendScoresToBackend(score1, score2, winner, durationFormated);
	}
		...
		endTime = new Date().getTime(); // Enregistrer le temps de fin
        winner = "Player 2"; // Définir le gagnant
		console.log("Date: " + date);
		console.log("Start Time: " + new Date(startTime).toLocaleTimeString());
		console.log("End Time: " + new Date(endTime).toLocaleTimeString());
		console.log("Winner: " + winner);
		...
		const durationFormated = new Date(Time).toISOString();
		console.log("duration formatee ", durationFormated);
		afficherFinJeu();
		sendScoresToBackend(score1, score2, winner, durationFormated);
	}
}
