...
//     const gameId = setupTabEventListeners();
//     function updateDashboard(gameId){
//     const allUsers = fetchAllUserByGame(gameId)
//         .then(allUsers => {
//             if (allUser){
//                 displayBestRanking(allUsers);
//             }
//             else {
//                 displayError('Fetch allUsers failed');
//                 return;
//             }
//         })
//         const myLeaderboard =  fetchMyLeaderboard(gameId)
//         .then(myLeaderboard => {
//             if (myLeaderboard){
//                 displayUserBasicStats(myLeaderboard);
//                 displayRatios(myLeaderboard);
//             }
//             else {
//                 displayError('Fetch Learderbord failed');
//                 return;
//             }
//         })
//         const myId = getCurrentUserId();
//         const myLastParties  =  fetchMyLastParties(gameId, myId)
//         .then(myLastParties => {
//             if (myLastParties){
//                 displayLastParties(myLastParties);
//             }
