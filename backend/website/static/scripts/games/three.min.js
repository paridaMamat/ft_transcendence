...
<<<<<<< HEAD
console.log("score2 avant",score2);
...
function setup()
{
	console.log("je suis dans setup");
...
{
<<<<<<< HEAD
	console.log("je suis dans creatscene");
	var WIDTH = 1000,
	  HEIGHT = 1000;
		console.log("WIDTH ET HEIGHT",WIDTH,HEIGHT);
	var VIEW_ANGLE = 70,
	  ASPECT = WIDTH / HEIGHT,
	  NEAR = 0.1,
	  FAR = 10000;
console.log("VIEW_ANGLE",VIEW_ANGLE);
