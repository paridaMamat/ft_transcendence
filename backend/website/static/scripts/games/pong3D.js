    ...
    .then(() => {
        ...
        $(document).ready(function() {
            ...
            if (partyId) {
                ...
                .then(data => {
                    ...
                    $('#opponent-username').text(data.user2.username);
                })
                .catch(error => {
                    console.error('Erreur lors de la récupération des données de la partie:', error);
                });
            } else {
                console.error('Aucun partyId trouvé dans le stockage local');
            }
        });
        ...
        function resetGame() {
            ...
            if (scorePlayer1 >= maxScore) {
                ...
                //sendScoresToBackend();
                setTimeout(window.location.href = "#page_finale/?id=${partyId}/", 5000);
